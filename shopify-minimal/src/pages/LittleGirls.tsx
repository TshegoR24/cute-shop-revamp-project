          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Adorable nightwear for little princesses. Soft, comfortable, and absolutely cute designs that make bedtime magical.
              </p>
            </div>
          </div>
        </section>
        <CategoryProductGrid category="little-girls" />
      </div>
      <Footer />
    </div>
  );
